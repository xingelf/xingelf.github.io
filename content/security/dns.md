...
DNS is essential in terms of the foot printing of the target.
DNS gives us a lot of information.

DNS探索は初期調査(footprinting)の基本動作です。

## whois

DNS管理組織は下表の通り。RIPEが欧州＋中東・中央アジアであることを意識しておけばOK.
...
windows 系ではこれしかありません。


- type=HINFO additional information about host such as OS, hardware and software.
- type=any 何でも

### dig

Unix系でもnslookupは使えますが、digが便利です。


## Zone Transfer / DNSゾーン転送

zone transferの実験ができるサイト　
...
2. host コマンドで登録されているホスト一覧をリスト ゾーン転送
...
3. dig コマンドで登録されているホスト一覧をリスト ゾーン転送
...
;; WHEN: Sun Aug 14 14:10:43 JST 2022
...
DNS階層にデジタル署名を導入することで、不正なDNSサーバによるDNSクエリを防止
...
- 再起・非再帰問い合わせ Recursive, Non-Recursive問い合わせ
